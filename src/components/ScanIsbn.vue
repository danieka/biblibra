...
<template>
    <div class="w-screen h-screen absolute top-0 left-0 bg-gray-200 flex flex-col justify-center align-center z-10">
        <div id="camera-view"></div>
        <div class="flex flex-row justify-center space-x-6 mt-4">
            <button class="button bg-gray-100 hover:bg-gray-200" @click="$emit('cancel')">Cancel</button>
        </div>
    </div>
</template>
